...
| Tab | Description |
|---|---|
| ![Deal Simulator](screenshots/Tab1.png) | Revenue curve with dual-axis demand overlay, scenario comparison table, and live KPI metrics |
| ![Competitive Viability](screenshots/Tab2.png) | Price viability curve with competitor anchor, basket context, and loyalty signal |
| ![Pricing Bands per SKU](screenshots/Tab3.png) | Portfolio bubble chart — current vs. revenue-optimal price across all SKUs |
| ![Basket Intelligence](screenshots/Tab4.png) | Basket share, margin impact simulation, and co-purchase contributor breakdown |
| ![Customer Behavior Profile](screenshots/Tab5.png) | Loyalty classification, price variation history, and recommended account stance |
...
[LinkedIn](https://linkedin.com/in/yufengwu1002) · [Portfolio](https://yfdawu.github.io)
